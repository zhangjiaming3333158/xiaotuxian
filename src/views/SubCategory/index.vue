...
const getFilterData = async () => {
  const res = await getCategoryFilterAPI(route.currentRoute.value.params.id)
...
<template>
  <div class="container ">
    ...
    <div class="sub-container">
      <el-tabs v-model="reqData.sortField" @tab-change="tableChange">
